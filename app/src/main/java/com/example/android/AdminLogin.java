...
public class AdminLogin extends AppCompatActivity{
        ...
        LogIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(CheckEditText){
                    ...
                    Toast.makeText(AdminLogin.this, "Please fill all form fields.", Toast.LENGTH_LONG).show();
    ...
    public void UserLoginFunction(final String email, final String password){
        ...
        class UserLoginClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(AdminLogin.this,"Loading Data",null,true,true);
            }
    ...
    {
        Intent intent = new Intent(AdminLogin.this, AdminForgot.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NO_HISTORY);
        startActivity(intent);
        finish();
    }
